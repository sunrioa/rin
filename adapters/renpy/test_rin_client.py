...
class RinClientTests(unittest.TestCase):
    ...
    def test_total_deadline_remains_active_while_response_drips(self):
        ...
        client = rin_client.RinClient(timeout=0.05, clock=clock.now)
        ...
        with self.assertRaises(rin_client.RinTransportError) as caught:
            client.health()
    ...
    def test_response_size_limit_is_enforced(self):
        ...
        negative = _Response(200, {"ok": True, "data": {}})
