...
基准在每回合之间都会重载游戏存档。Sidecar Ready 耗时 73.28 ms。100 回合后
Rin 保留 536,612 Bytes；按每小时 60 回合做保守线性投影，100 小时为
32,196,720 Bytes。仅启动阶段的 Local Mode 耗时 125.83 ms，仍显示游戏编写的茶
...
139 行接入代码，P95 延迟约为 6.3 倍。因此，这条小规则不值得引入 Rin。只有当游戏
