...
class ControlClientTests(unittest.TestCase):
    def test_all_v2_client_routes_use_shared_fixture(self):
        ...
        cases = (
            ...
            (client.register_host, ({"host_id": "host.fixture"},), "POST", "/control/v2/host/register", {"host_id": "host.fixture"}),
            (client.renew_host, ({"host_id": "host.fixture"},), "POST", "/control/v2/host/renew", {"host_id": "host.fixture"}),
            (client.unregister_host, ({"host_id": "host.fixture"},), "POST", "/control/v2/host/unregister", {"host_id": "host.fixture"}),
            (client.publish_world, ({"host_id": "host.fixture"},), "POST", "/control/v2/host/publish", {"host_id": "host.fixture"}),
            (client.poll_host, ({"host_id": "host.fixture"},), "POST", "/control/v2/host/poll", {"host_id": "host.fixture"}),
            (client.report_gateway_result, ({"host_id": "host.fixture"},), "POST", "/control/v2/host/gateway-result", {"host_id": "host.fixture"}),
            (client.acknowledge_host, ({"host_id": "host.fixture"},), "POST", "/control/v2/host/ack", {"host_id": "host.fixture"}),
            (client.report_host_run, ({"host_id": "host.fixture"},), "POST", "/control/v2/host/run", {"host_id": "host.fixture"}),
            (client.report_host_outcome, ({"host_id": "host.fixture"},), "POST", "/control/v2/host/outcome", {"host_id": "host.fixture"}),
            (client.configure_host_signals, ({"host_id": "host.fixture"},), "POST", "/signals/v1/host/settings", {"host_id": "host.fixture"}),
            (client.publish_host_signal, ({"host_id": "host.fixture"},), "POST", "/signals/v1/host/publish", {"host_id": "host.fixture"}),
            (client.list_actor_signals, (FIXTURES["actor_target"],), "POST", "/signals/v1/list", FIXTURES["actor_target"]),
            (client.wait_actor_signals, (FIXTURES["actor_target"],), "POST", "/signals/v1/wait", FIXTURES["actor_target"]),
