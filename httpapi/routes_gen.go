...
var generatedContractRoutes = [...]ContractRoute{
	...
	{OperationID: "set_actor_agency", Method: http.MethodPost, Path: "/v2/session/agency", SuccessStatus: http.StatusOK, RequestSchema: "SetActorAgencyRequest"},
...
func (s *Server) registerContractRoutes(mux *http.ServeMux) {
	handlers := map[string]http.HandlerFunc{
		...
		"set_actor_agency":      s.setActorAgency,
