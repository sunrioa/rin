...
var generatedContractRoutes = [...]ContractRoute{
	...
	{OperationID: "session_stats", Method: http.MethodPost, Path: "/v1/session/stats", SuccessStatus: http.StatusOK},
	{OperationID: "archive_session", Method: http.MethodPost, Path: "/v1/session/archive", SuccessStatus: http.StatusOK},
	{OperationID: "delete_session", Method: http.MethodPost, Path: "/v1/session/delete", SuccessStatus: http.StatusOK},
	...
	{OperationID: "export_session", Method: http.MethodPost, Path: "/v1/session/export", SuccessStatus: http.StatusOK},
	{OperationID: "import_session", Method: http.MethodPost, Path: "/v1/session/import", SuccessStatus: http.StatusOK},
